...
INSERT INTO `address` (`id`, `pin_name`, `street`, `city`, `state`, `zip`) VALUES (5, 'Mile High Condos', '34 Borscht Dr', 'Denver', 'CO', 80014);
...
INSERT INTO `address` (`id`, `pin_name`, `street`, `city`, `state`, `zip`) VALUES (8, 'All of Downtown Denver', 'Downtown', 'Denver', 'CO', 80014);
...
INSERT INTO `snitch` (`id`, `user_id`, `address_id`, `category_id`, `title`, `description`, `create_date`, `img_url`, `enabled`, `resolved`, `resolution_date`, `resolution`) VALUES (5, 3, 5, 5, 'Loud neighbors!', 'A very loud, possibly Ukranian family moved upstairs with their dog. They are always playing an accordion. Does anyone else hear them?', '2020-06-01 11:44:00', 'https://images.unsplash.com/photo-1563485572474-3392e2a0c3f7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80', 1, 0, NULL, NULL);
